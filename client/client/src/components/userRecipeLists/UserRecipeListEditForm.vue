<template>
    <base-button class="border" v-if="hideForm" @click="hideForm = false">Update List</base-button>
    <base-card v-else>
        <h2>Update Recipe List:</h2>
        <form @submit.prevent="submitForm">
            ...
            <base-button class="border">Update List</base-button>
