...
const UPDATE_DELETE_INGREDIENT_DETAILS_URL = "http://localhost:8081/v1/users/:username/lists/:listId/recipes/:recipeId/ingredients/:ingredientDetailsId";
const CREATE_INGREDIENT_DETAILS_URL = "http://localhost:8081/v1/users/:username/lists/:listId/recipes/:recipeId/ingredients";
